  ...
  return (
     <div className="relative px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="absolute bottom-6 right-8 sm:right-16 lg:right-142">
          ...
          <div className="relative z-10 space-y-8 pt-8">
            <div>
                <h1 className="font-sans text-2xl  tracking-tight text-gray-900 sm:text-4xl lg:text-5xl my-[0.5em]">
              Stop Drowning in To-Dos.
            </h1>

            <h2 className="font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              Get Things Done with{" "}
              <span className="bg-gradient-to-r from-pink-400 to-pink-500 bg-clip-text text-transparent">DoneFlow</span>
            </h2>
            </div>

            <p className="mx-auto max-w-2xl text-md text-gray-600 sm:text-md">
