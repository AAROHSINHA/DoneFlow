      ...
      <div className="relative px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="absolute left-4 top-8 sm:left-8 lg:left-16">
            <div className="h-16 w-16 overflow-hidden rounded-full border-4 border-white shadow-lg bg-gray-200"></div>
          </div>

          <div className="absolute right-4 top-12 sm:right-8 lg:right-16">
            <div className="h-12 w-12 overflow-hidden rounded-full border-4 border-white shadow-lg bg-gray-200"></div>
          </div>

          <div className="absolute bottom-16 right-8 sm:right-16 lg:right-32">
            <div className="h-20 w-20 overflow-hidden rounded-full border-4 border-white shadow-lg bg-gray-200"></div>
          </div>

          {/* Main content */}
          <div className="relative z-10 space-y-8 pt-8">
            <h1 className="font-sans text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              Stop Drowning in To-Dos.
            </h1>

            <h2 className="font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
            ...
            >
              Start today - <span className="text-pink-400">It's Free!</span>
            </button>
            </div>
          </div>
        </div>
