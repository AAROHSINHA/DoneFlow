  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 relative animate-in fade-in-0 zoom-in-95 duration-200">
        ...
        <TimeDisplay time={time} estimateTime={estimateTime}/>
        <ControlButtons isRunning={isRunning} isPaused={isPaused} setIsRunning={setIsRunning} setIsPaused={setIsPaused} setTime={setTime} />
