...
export default function AddTask() {
  ...
  return (
    <div className="w-full max-w-[26rem] h-full">
      ...
      className="w-[100%] h-[100%] bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-2xl shadow-lg hover:shadow-md transition-all duration-200 flex items-center justify-center group hover:cursor-pointer"
    >
